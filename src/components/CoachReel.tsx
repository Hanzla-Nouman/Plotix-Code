...
const CoachReel: React.FC<CoachReelProps> = (props) => {
  ...
  let coachesData: (CoachWithRelations | null)[] = prepareDataForMapping({
    data: usersData,
    isLoading,
  });
          ...
          <div className="w-full flex flex-col sm:grid grid-cols-6 sm:gap-x-4 lg:flex lg:flex-row lg:overflow-x-auto 2xl:grid 2xl:grid-cols-12">
            {coachesData
              ...
              .map((coach, i) => (
                <div
                  key={i}
                  className="mb-6 col-span-3 lg:min-w-80 2xl:col-span-3"
                >
                  {/* {console.log("I am coach number",i,coach)} */}
