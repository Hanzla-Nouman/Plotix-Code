...
//               <div className="ml-auto flex border items-center ">
//                 <div className="hidden lg:flex lg:flex-1 mr-8 inset-x-0 absolute lg:items-center lg:justify-end lg:space-x-6">
//                   {user ? null : (
//                     <Link
//                       href="/apply"
    ...
    <div className="bg-white sticky top-0 z-50 inset-x-0 h-16">
      <header className="relative bg-white">
        <MaxWidthWrapper>
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              <div className="ml-4 border flex lg:ml-0">
                <Link className="flex " href="/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
